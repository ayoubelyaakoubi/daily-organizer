...
import { CheckCircle2, Circle, Trophy, Target, NotebookPen, Save, Pencil, Quote } from 'lucide-react'
...
export default function DayView({ year, month, day }) {
  const { objectives, dayData, dayNotes, toggleObjective, getDayCompletion, setDayNote } = useStore()
